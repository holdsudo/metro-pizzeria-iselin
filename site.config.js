...
const SITE = {
  ...
  hero: {
    ...
    posterCaption: "The Paneer Tikka \u2014 straight out of the oven"
  },
  ticker: [
  ...
  gallery: [
    ...
    { src: "assets/stage-tikka.jpg", alt: "Paneer tikka pizza closeup", caption: "Paneer tikka, house signature" },
  ...
  menu: {
    ...
    items: [
      { id: 'classic-pizza', photo: '', category: 'classics', name: 'Classic Pizza', description: 'Shredded mozzarella and pizza sauce.', basePrice: 8.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      { id: 'margherita-pizza', photo: '', category: 'classics', name: 'Margherita Pizza', description: 'Fresh mozzarella, fresh basil, olive oil and margherita sauce.', basePrice: 10.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      { id: 'pepperoni-pizza', photo: '', category: 'classics', name: 'Pepperoni Pizza', description: 'Sliced pepperoni, shredded mozzarella and pizza sauce.', basePrice: 9.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      { id: 'onions-and-peppers-pizza', photo: '', category: 'classics', name: 'Onions and Peppers Pizza', description: 'Sliced onions, peppers, shredded mozzarella and pizza sauce.', basePrice: 9.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      { id: 'hawaiian-pizza', photo: '', category: 'classics', name: 'Hawaiian Pizza', description: 'Sliced ham, juicy pineapple, shredded mozzarella & pizza sauce.', basePrice: 11.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      ...
      { id: 'buffalo-chicken-pizza', photo: '', category: 'specialty', name: 'Buffalo Chicken Pizza', description: 'Crispy buffalo chicken & shredded mozzarella, drizzled with blue cheese dressing.', basePrice: 10.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
      { id: 'veggie-lovers-pizza', photo: 'assets/food-veggie.jpg', category: 'specialty', name: 'Veggie Lovers Pizza', description: 'Broccoli, mushrooms, onions, peppers, olives, shredded mozzarella & pizza sauce.', basePrice: 10.00, sizes: ['One size'], toppings: ['Pepperoni', 'Sausage', 'Bacon', 'Meatballs', 'Chicken', 'Ham', 'Onions', 'Peppers', 'Mushrooms', 'Broccoli', 'Spinach', 'Black olives', 'Jalape\u00f1os', 'Garlic', 'Pineapple', 'Extra cheese'] },
